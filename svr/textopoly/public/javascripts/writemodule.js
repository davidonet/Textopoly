...
var writingBox = '<!-- WRITING BOX --><div id="writingBox"><div id="writingArea" class="msg s l4"><textarea name="t" rows="9" maxlength="600" cols="70" spellcheck="false"  wrap="off"></textarea><div id="writingCommands"><input type="hidden" name="x" min="-100" max="100" style="display: none; " value="3"><input type="hidden" name="y" min="-100" max="100" style="display: none; " value="-6"><select id="size" name="s"><option value="s">Small</option><option value="l">Long</option></select><select name="a"><option>Ribouldingue</option><option>Filochard</option><option>Croquignol</option><option>Manounou</option><option>Croquenot</option></select><select id="color" name="c" value="butter" style="background-color: rgb(237, 212, 0); "><option>butter</option><option>orange</option><option>chocolate</option><option>chameleon</option><option>skyblue</option><option>plum</option><option>scarletred</option></select><input id="closeBox" type="button" value="X"><input type="submit" value="OK"></div><div id="nw" class="handle">nw</div><div id="n" class="handle">n</div><div id="ne" class="handle">ne</div><div id="e" class="handle">e</div><div id="se" class="handle">se</div><div id="s" class="handle">s</div><div id="sw" class="handle">sw</div><div id="w" class="handle">w</div></div></div><!-- WRITING BOX -->';
